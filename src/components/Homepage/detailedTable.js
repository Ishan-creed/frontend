...
const TableDetail = () => {
  ...
  try {
     ...
     await axios.put("https://mybackend1-b509.onrender.com/updateUser",{
      formData
     })
          ...
          <div style={InventoryForm}>
            <form className="login-form" style={formStyle}>
              ...
              <input
                ...
                style= {{margin:"20px",padding:"5px",borderRadius:"10px"}} />
              <br />
              <label htmlFor="itemname">Update User Name</label> <br />
              <input
                type="text"
                id="itemname"
                name="name"
                ...
                />
              <br />
              <label htmlFor="curval">Update Contact</label>
              <input
                type="number"
                id="curval"
                name="phone"
              ...
              <br />
              <label htmlFor="quantity">Update Email</label>
              <input
                type="text"
                id="quantity"
                name="email"
                ...
                onChange={handleChange}
                style= {{margin:"20px",padding:"5px",borderRadius:"10px"}} />
              <label htmlFor="quantity">Update your hobbies</label>
              <input
                type="text"
                id="quantity"
                name="hobbies"
            ...
            <div className="scrolli" style={{textAlign:"center"}}>
                <MainContent>
                    ...
                    <button id="updinvnt" onClick={handleUpdateInventory} style={addInventoryModalStyles.sideButtons.btn}>Update User</button>
                    </div>
                </MainContent>
                <Table />
            </div>
