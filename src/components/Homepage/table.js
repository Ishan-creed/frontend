...
const handleButtonClick2 = async (row) => {
    ...
    try{
        await axios.delete("https://mybackend1-b509.onrender.com/deleteUser",{
            params: {
                id: myId
            }
        });
...
const handleButtonClick3 = (row) => {
    ...
    axios.post('https://mybackend1-b509.onrender.com/mail', data)
    .then(response => {
        ...
        <tbody {...getTableBodyProps()}>
          ...
          {page.map((row) => {
            ...
            return (
              ...
              <button style={updateInventoryModalStyles.sideButtons.btn} onClick={() => handleUpdateInventory()}>
                Update
              </button>
            ) : (
